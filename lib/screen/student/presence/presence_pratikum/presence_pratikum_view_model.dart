...
import 'package:presence_kita/model/api/presence_pratikum_api.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:file_picker/file_picker.dart';
import 'dart:developer';

class PresencePratikumViewModel extends ChangeNotifier {
  final PresencePratikumApi _api = PresencePratikumApi();
    ...
    try {
      ...
      if (qrCodeResult.isNotEmpty) {
        ...
        Map<String, dynamic> data = {
          ...
          'session_pratikum_id': qrCode['session_pratikum_id'],
          'classroomspratikum_id': qrCode['classroomspratikum_id'],
          'status': 'hadir'
        };
